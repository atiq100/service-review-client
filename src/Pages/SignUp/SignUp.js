...
const SignUp = () => {
	...
	<form novalidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
        ...
        <div className="space-y-2">
				...
				<input type="email" name="name" id="email" placeholder="Your Email" className="w-full px-3 py-2 border rounded-md dark:border-gray-700  dark:text-gray-400 focus:dark:border-sky-400" />
			</div>
			<div className="space-y-2">
		...
		<button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-sky-500/100 dark:text-gray-900">Sign up</button>
	</form>
</div>
       </div>
    );
