	...
	<form onSubmit={handleSubmit}  className="space-y-8 ">
        ...
        <div className="space-y-2">
            ...
            <div className="space-y-2">
				...
				<input type="text" name="photoURL"  placeholder="Your Photo URL" className="w-full px-3 py-2 border rounded-md dark:border-gray-700  dark:text-gray-400 focus:dark:border-sky-400" />
			</div>
			<div className="space-y-2">
